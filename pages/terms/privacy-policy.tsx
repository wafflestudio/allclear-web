...
(주)신선한여울(이하 "회사"라고 합니다)은 올클 및 관련 제반 서비스(이하 “서비스”라고 합니다)를 이용하는 회원의 개인정보 보호를 소중하게 생각하고, 회원의 개인정보를 보호하기 위하여 항상 최선을 다해 노력하고 있습니다.
...
1. 회사는 회원가입 등 서비스 제공 및 계약이행을 위해 아래와 같이 개인정보를 수집할 수 있습니다.
...
1. 회사는 웹 서비스는 인터넷을 통하여 회원의 정보를 저장하고 수시로 찾아내는 쿠키(cookie)를 설치, 운용하고 있습니다. 회원이 웹사이트에 접속을 하면 회원의 브라우저에 있는 쿠키의 내용을 읽고, 추가정보를 찾아 접속에 따른 성명 등의 추가 입력없이 서비스를 제공할 수 있습니다.
...
현 「개인정보취급방침」 내용의 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일 전부터 알림과 전자우편을 통해 고지하고, 개정 내용이 이용자에게 불리할 경우에는 30일간 고지할 것입니다.`
  .trim()
  .split('###')
  .map((it) => {
        ...
        <div className="mx-auto flex max-w-screen-xl flex-col justify-between px-4">
          <article className="format format-sm sm:format-base lg:format-lg format-blue mx-auto w-full max-w-2xl whitespace-pre-wrap">
            ...
            <p className="lead prose mb-4">
              {`(주)신선한여울은 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.`}
            </p>
              ...
              {privacyPolicyKr.map((it) => (
                <section key={it.title} className="mb-8">
                  <li className="mb-4">
                    ...
                    <p className="prose whitespace-pre-wrap">{it.content}</p>
                  </li>
                </section>
              ))}
            </ol>
